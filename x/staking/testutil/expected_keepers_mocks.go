...
import (
	...
	exported "github.com/cosmos/cosmos-sdk/x/auth/vesting/exported"
...
// MockVestingKeeper is a mock of VestingKeeper interface.
type MockVestingKeeper struct {
	ctrl     *gomock.Controller
	recorder *MockVestingKeeperMockRecorder
}

// MockVestingKeeperMockRecorder is the mock recorder for MockVestingKeeper.
type MockVestingKeeperMockRecorder struct {
	mock *MockVestingKeeper
}

// NewMockVestingKeeper creates a new mock instance.
func NewMockVestingKeeper(ctrl *gomock.Controller) *MockVestingKeeper {
	mock := &MockVestingKeeper{ctrl: ctrl}
	mock.recorder = &MockVestingKeeperMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockVestingKeeper) EXPECT() *MockVestingKeeperMockRecorder {
	return m.recorder
}

// IterateVestingAccounts mocks base method.
func (m *MockVestingKeeper) IterateVestingAccounts(ctx types.Context, process func(exported.VestingAccount) bool) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "IterateVestingAccounts", ctx, process)
}

// IterateVestingAccounts indicates an expected call of IterateVestingAccounts.
func (mr *MockVestingKeeperMockRecorder) IterateVestingAccounts(ctx, process interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IterateVestingAccounts", reflect.TypeOf((*MockVestingKeeper)(nil).IterateVestingAccounts), ctx, process)
}
