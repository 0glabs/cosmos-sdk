...
// StakingTokenCirculatingSupply mocks base method.
func (m *MockStakingKeeper) StakingTokenCirculatingSupply(ctx types.Context) math.Int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StakingTokenCirculatingSupply", ctx)
	ret0, _ := ret[0].(math.Int)
	return ret0
}

// StakingTokenCirculatingSupply indicates an expected call of StakingTokenCirculatingSupply.
func (mr *MockStakingKeeperMockRecorder) StakingTokenCirculatingSupply(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StakingTokenCirculatingSupply", reflect.TypeOf((*MockStakingKeeper)(nil).StakingTokenCirculatingSupply), ctx)
}
